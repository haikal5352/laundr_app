        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-2xl p-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="border border-gray-200 rounded-xl p-4 mb-4 <?php echo e($address->is_default ? 'bg-blue-50 border-blue-300' : ''); ?>">
                        <div class="flex justify-between items-start mb-2">
                            <div>
                                <span class="font-bold text-gray-800"><?php echo e($address->label); ?></span>
                            ...
                            <div class="flex gap-2">
                                <?php if(!$address->is_default): ?>
                                    <form action="<?php echo e(route('addresses.default', $address->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="text-xs text-blue-600 hover:underline">Jadikan Utama</button>
                                    </form>
                                <?php endif; ?>
                                <form action="<?php echo e(route('addresses.destroy', $address->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus alamat ini?')">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="text-sm text-gray-600">
                            <p class="font-medium"><?php echo e($address->recipient); ?></p>
                            <p>📞 <?php echo e($address->phone); ?></p>
                            <p class="text-gray-500"><?php echo e($address->address); ?></p>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\achma\Documents\PROYEK 2\laundr_app\resources\views/profile/addresses.blade.php ENDPATH**/ ?>