                ...
                <div class="block pl-1">
                    <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                        <input id="remember_me" type="checkbox"
                            ...
                            name="remember">
                        <span
                            class="ml-2 text-sm text-slate-600 font-bold group-hover:text-blue-600 transition-colors"><?php echo e(__('Ingat Saya')); ?></span>
                    </label>
                </div>
...
<?php endif; ?><?php /**PATH C:\Users\achma\Documents\PROYEK 2\laundr_app\resources\views/auth/login.blade.php ENDPATH**/ ?>