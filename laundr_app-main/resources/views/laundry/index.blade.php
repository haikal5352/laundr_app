...
@endif
    ...
    <div class="grid grid-cols-3 gap-3">
        <label class="cursor-pointer">
            ...
            <div class="rounded-xl border-2 border-slate-100 p-3 text-center hover:bg-slate-50 peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all">
                <div class="text-2xl mb-1">💵</div>
                <div class="text-xs font-bold text-slate-600">Tunai</div>
            </div>
        </label>
        ...
        <label class="cursor-pointer">
            ...
            <div class="rounded-xl border-2 border-slate-100 p-3 text-center hover:bg-slate-50 peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all">
                <div class="text-2xl mb-1">📱</div> <div class="text-xs font-bold text-slate-600">QRIS</div>
            </div>
        </label>
        ...
        <label class="cursor-pointer">
            ...
            <div class="rounded-xl border-2 border-slate-100 p-3 text-center hover:bg-slate-50 peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all">
                <div class="text-2xl mb-1">🏦</div>
                <div class="text-xs font-bold text-slate-600">Transfer</div>
            </div>
        </label>
    </div>
</div>
